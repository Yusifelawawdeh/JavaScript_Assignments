/* 
Important note 
The behavior of most browsers has changed since this video was shot, 
...
while (true) {
    search = prompt("Search a product you would like to buy, Type 'list' to show all the products and 'quit' to exit");
    ...
    if (search === 'quit') {
        ...
        if ( inStock.indexOf(search) > -1 ) {
            ...
            print(search + ' is not in stock... sorry =(');
        }
    }
}


// print function wont work now =(
